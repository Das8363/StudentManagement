				...
				<div class="col-12 col-md-6 bsb-tpl-bg-platinum">
					<div
						...
						<img class="img-fluid rounded mx-auto my-4" loading="lazy"
							src="https://gla.ac.in/blog/wp-content/uploads/2023/06/Reasons-why-higher-education-needs-to-be-highlighted.jpg" width="245" height="80"
							alt="Image not found">
						<p class="mb-0">
